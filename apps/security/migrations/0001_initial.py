    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=15, validators=[django.core.validators.MinLengthValidator(10)], verbose_name='phone number')),
                ...
                ('privacy_settings', models.JSONField(default=dict, help_text='User privacy preferences', verbose_name='privacy settings')),
                ('notification_settings', models.JSONField(default=dict, help_text='User notification preferences', verbose_name='notification settings')),
